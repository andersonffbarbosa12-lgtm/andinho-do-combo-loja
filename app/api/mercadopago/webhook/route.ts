  ...
  try {
    ...
    */
    ...
    if (!xSignature || !xRequestId) {
      console.warn("Webhook Mercado Pago sem headers de assinatura.");
      return NextResponse.json(
    ...
    try {
      ...
      console.log(
        `Webhook Mercado Pago autenticado. Payment ID: ${paymentId}`
      );
    } catch (error) {
      ...
      console.error("Erro inesperado validando webhook:", error);
      return NextResponse.json(
