      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 border-t border-yellow-500/10 bg-black/95 p-4 backdrop-blur">
        <div className="mx-auto max-w-3xl">
          <button
            ...
            className="flex w-full items-center justify-between rounded-2xl bg-yellow-400 px-5 py-4 text-black shadow-2xl disabled:bg-gray-700 disabled:text-gray-400 disabled:opacity-100"
          >
            <div className="text-left">
              <p className="text-[10px] font-bold uppercase">Total do pedido</p>
              <p className="text-lg font-black">{formatPrice(total)}</p>
            </div>
            <span className="max-w-[58%] text-right text-sm font-black">
              {!isOpen
